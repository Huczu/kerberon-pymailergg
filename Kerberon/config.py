...
#sms sender
numer = "+48609814917" # koniecznie +48
...
emails = ( #domain, (login, pass), {pamiec, pamiec2}
    ("huczu.pl",("admin@huczu.pl","nxrn0833",),{"email_memory":0, "mem":0,})
    ("gmail.com",("huczu93@gmail.com","yifwtnhfxnusewhu",), {"email_memory":0, "mem":0}),
    ("huk.mail.pl",("andrzej@huk.mal.pl","233raFgg",), {"email_memory":0, "mem":0}),
)
